...
def self.metadata
  ...
  def run
    ...
    filter = _get_entity_name
    files = _get_files(filter)
  ...
  def _get_files(year_filter)
    ...
    if year_filter == "recent"
      ...
      years = ["2019","2018","2017","2016","2015","2014","2013","2012","2011","2010","2009","2008","2007","2006","2005","2004","2003","2002","2001","2000","1999"]
      years.each do |y|
